...
var PushNotificationController = /** @class */ (function () {
    ...
    PushNotificationController.prototype.subscribe = function (req, res) {
    ...
    PushNotificationController.prototype.push = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var payload;
            return __generator(this, function (_a) {
                if (req.body) {
                    ...
                    webpush.sendNotification(this.subscription, payload)
                        .then(function () { return res.send({ success: true, message: 'Notification successfull' }); })["catch"](function (err) { return res.send({ success: false, message: err.message }); });
                    return [2 /*return*/];
                }
